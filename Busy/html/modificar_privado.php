...
$id = $_GET["id"];
$sql = $conexion->query(" select * from privado where id_ruta=$id ");
include "controlador/modificar_privado.php"
                               ...
                               <?php
                                    ...
                                    <input type="hidden" name="id" value="<?= $id = $_GET["id"] ?>">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputName">Capacidad de bus</label>
                                                <input type="textarea" autocomplete="off" class="form-control" name="capa"
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="inputName">Telefono de la empresa</label>
                                                <input type="tel" autocomplete="off" class="form-control" name="tel"
                                                    value="<?= $datos->tel ?>" required>
                                            </div>
                                            </div>
                                        <?php } ?>
                                        <button type="submit" class="btn btn-primary" name="btnprivado"
