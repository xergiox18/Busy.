...
<body>
    ...
    <header class="background-white box-shadow">
        <div class="background-main-color padding-tb-5px">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm">
                        <ul class="list-inline align-center margin-0px text-white">
        ...
        <div class="header-output">
            <div class="container header-in">
                <div class="row">
                    <div class="col-lg-3">
                        <a id="logo" href="01-home.html" class="d-inline-block margin-tb-10px"><img
                        ...
                        <ul id="menu-main" class="nav-menu float-right link-padding-tb-20px">
                            ...
                            <li class="has-dropdown"><a href="#">Base de datos</a>
                                <ul class="sub-menu">
                                    ...
                                    <li class="has-dropdown"><a href="registro_conductores.php">Conductores</a>
                                    </li>
    ...
    <section class="background-grey-1 padding-tb-35px text-grey-4">
        <div class="container">
            ...
            <ol
                class="breadcrumb z-index-2 position-relative no-background padding-tb-10px padding-lr-0px  margin-0px float-md-right">
    ...
    <div class="margin-tb-40px">
        <div class="container">
            <p>
                Bienvenido, Desde aquí podrá realizar el manejo y control de su base de datos, modificar su correo y
                contraseña, realizar un seguimiento a sus empleados y visualizar o modificar la información de ventas,
                Vehiculos
                conductores, vehiculos y destinos.
            </p>
            <br><br><br><br><br><br>
            <p>Si tiene algun problema comuniquese con nosotros y con gusto le ayudaremos.</p>
            <div class="col-3"><a href="#" class="btn btn-md border-2 border-radius-0 btn-info btn-block">Necesito
                    ayuda</a></div>
    ...
    <footer>
        <div class="container">
                ...
                <div class="col-lg-6">
                    <div class="about">
                        ...
                        <p class="text-grey-2">
                            ...
                            porttitor vehicula gravida at, accumsan bibendum tincidunt imperdiet. Maecenas quis magna
                            faucibus, varius ante sit amet, varius augue. Praesent aliquam, a imperdiet lacus libero ac
                            tellus. Nunc fringilla ullamcorper quam at lacinia.
                        </p>
                    </div>
                </div>
                <div class="col-lg-3">
                    <ul class="footer-menu row margin-0px padding-0px list-unstyled">
                        ...
                        <li class="col-lg-6 col-md-6 padding-tb-5px"><a href="#" class="text-main-color">Featured</a>
                        </li>
                        <li class="col-lg-6 col-md-6 padding-tb-5px"><a href="#" class="text-main-color">Feedback</a>
                        </li>
                        <li class="col-lg-6 col-md-6 padding-tb-5px"><a href="#" class="text-main-color">Ask a
                                Question</a></li>
                        <li class="col-lg-6 col-md-6 padding-tb-5px"><a href="#" class="text-main-color">Team</a></li>
                        <li class="col-lg-6 col-md-6 padding-tb-5px"><a href="#" class="text-main-color">Maintenance</a>
                        </li>
                        <li class="col-lg-6 col-md-6 padding-tb-5px"><a href="#" class="text-main-color">Get a Quote</a>
                        </li>
                        <li class="col-lg-6 col-md-6 padding-tb-5px"><a href="#" class="text-main-color">Contact Us</a>
                        </li>
                        <li class="col-lg-6 col-md-6 padding-tb-5px"><a href="#" class="text-main-color">Alerts
                                messages</a></li>
                    </ul>
                </div>
                <div class="col-lg-3">
                    <ul class="images-feed row no-gutters margin-0px padding-0px list-unstyled">
                        <li class="col-lg-4 col-md-4 padding-tb-5px"><a href="#" class="padding-lr-5px d-block"><img
                                    src="http://placehold.it/400x400" alt=""></a></li>
                        <li class="col-lg-4 col-md-4 padding-tb-5px"><a href="#" class="padding-lr-5px d-block"><img
                                    src="http://placehold.it/400x400" alt=""></a></li>
                        <li class="col-lg-4 col-md-4 padding-tb-5px"><a href="#" class="padding-lr-5px d-block"><img
                                    src="http://placehold.it/400x400" alt=""></a></li>
            ...
            <div class="row padding-tb-30px border-top-1 border-grey-1">
                <div class="col-lg-4">
                    <p class="text-sm-center text-lg-left"><span class="text-third-color">Travelz</span> | @2017 All
