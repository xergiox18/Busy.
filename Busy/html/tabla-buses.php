...
<body>
    ...
    <div class="background-light-grey padding-tb-50px">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark  background-main-color " id="mainNav">
                <a class="navbar-brand" href="dashboard-home.html">Tabla de Vehículos </a>
                            ...
                            <div class="container margin-tb-15px">
                                <table id="example" class="table table-striped table-bordered" cellspacing="0"
                                    ...
                                    <tbody>
                                        ...
                                        include "controlador/eliminar-bus.php";
                                        $sql = $conexion->query(" select * from buses ");
                                        ...
                                        <tr>
                                            ...
                                            <td> <a href="modificar_buses.php?id=<?= $datos->id_bus ?>" class="btn btn-small btn-warning"><i
                                                        class="fa-solid fa-pen-to-square"></i></a></td>
                                            <td> <a onclick="return eliminar()" href="tabla-buses.php?id=<?= $datos->id_bus ?>"
