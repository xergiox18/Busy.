    ...
    <div class="background-light-grey">
        ...
        <div class="container padding-tb-50px">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark background-main-color " id="mainNav">
                <a class="navbar-brand" href="dashboard-home.html">Registro de Vehículos</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            ?>
                                    <form method="POST">
                                        <?php
                                include "controlador/registro_buses.php";
                                include "controlador/login.php"
                                    ?>

                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputName">Placa del Vehículo</label>
                                                <input type="text" autocomplete="off" class="form-control" name="placa"
                                                    required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputName">Modelo</label>
                                                <input type="text" autocomplete="off" class="form-control" name="modelo"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputNumber">Marca</label>
                                                <input type="text" autocomplete="off" class="form-control" name="marca"
                                                    required>
                                            </div>

                                        </div>
                                        <button type="submit" class="btn btn-primary" name="btnbuses"
