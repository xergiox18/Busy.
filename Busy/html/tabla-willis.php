                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Tabla de rutas</li>
                            </ol>
                            ...
                            <div class="container margin-tb-15px">
                                <table id="example" class="table table-striped table-bordered" cellspacing="0"
                                    ...
                                    <tbody>
                                        ...
                                        include "controlador/eliminar-willis.php";
                                        $sql = $conexion->query(" select * from willis ");
                                        ...
                                        <tr>
                                            ...
                                            <td> <a href="modificar_willis.php?id=<?php echo $row ['id_ruta'] ?>" class="btn btn-small btn-warning"><i
                                                        class="fa-solid fa-pen-to-square"></i></a></td>
                                            <td> <a onclick="return eliminar()" href="tabla-willis.php?id=<?php echo $row ['id_ruta'] ?>"
