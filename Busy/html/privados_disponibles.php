    ...
    <div class="row no-gutters">
        ...
        <div class="col-lg-8">
            <div class="padding-20px">
                ...
                <a href="pasarela.php" class="float-lg-right btn-sm btn-lg background-grey-1 text-grey-2 text-center text-uppercase pull-top-30px">Comprar </a>
                ...
                <small class="text-uppercase text-extra-small margin-right-30px">
                    ...
                    <small class="text-uppercase text-extra-small margin-right-30px">
                        <a href="#" class="text-grey-4"><i class="fa fa-chevron-up margin-right-5px"></i>
                        Capacidad del bus<span class="text-third-color margin-right-5px"> <?php echo $row ['intervalo_ruta'] ?></span> </a>
                    </small>
                    <br>
                    <small class="text-uppercase text-extra-small margin-right-30px">
                        <a href="#" class="text-grey-4"><i class="fa fa-chevron-up margin-right-5px"></i>
                        Teléfono : <span class="text-third-color margin-right-5px"> <?php echo $row ['tel'] ?></span> </a>
                    </small>
