...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 position-inherit">
                        ...
                        <ul id="menu-main" class="nav-menu float-right link-padding-tb-20px">
                            <li class="active mega-menu mega-links mega-links-4columns"><a
                                    href="01-home.html">Inicio</a>
    ...
    <!-- // Header  -->
    <div class="background-light-grey padding-tb-50px">

       
            <!-- Navigation-->
            <nav class="navbar navbar-expand-lg navbar-dark  background-main-color " id="mainNav">
                <a class="navbar-brand" href="dashboard-home.html">Tabla de rutas </a>
            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item "><a href="tabla-conductores.php">Registros guardados</a>
                                </li>
                                <li class="active">Tabla de buses privados</li>
                            </ol>
                            ...
                            <div class="container margin-tb-15px">
                                <table id="example" class="table table-striped table-bordered" cellspacing="0"
                                    ...
                                    <tbody>
                                        ...
                                        include "controlador/eliminar-privado.php";
                                        $sql = $conexion->query(" select * from  privado ");
                                        ...
                                        <tr>
                                            ...
                                            <td> <a href="modificar_privado.php?id=<?php echo $row ['id_ruta'] ?>" class="btn btn-small btn-warning"><i
                                                        class="fa-solid fa-pen-to-square"></i></a></td>
                                            <td> <a onclick="return eliminar()" href="tabla-privados.php?id=<?php echo $row ['id_ruta'] ?>"
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">Selecciona salir si quieres cerrar la sesión actual, en caso
