    ...
    <div class="background-light-grey">
        ...
        <div class="container padding-tb-50px">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark background-main-color " id="mainNav">
                <a class="navbar-brand" href="dashboard-home.html">Registro de willis</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Buses privados</li>
                            ...
                            <?php
                                ...
                                <?php
                                    include "controlador/registro_privado.php";
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="inputNumber">Capacidad de bus</label>
                                            <input type="text" autocomplete="off" class="form-control" name="capacidad" required>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="inputtext">$Precio de pasaje</label>
                                            <input type="text" autocomplete="off" class="form-control" name="precio" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputfile">Imagen</label>
                                            <input type="file" autocomplete="off" class="form-control" name="imagen" accept="image/*" required>
                                        </div>
                                    </div>

                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="inputnumber">Telefono de la empresa</label>
                                            <input type="tel" autocomplete="off" class="form-control" name="tel" required>
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-primary" name="btnprivado" value="ok">Registrar</button>
                                </form>
                            </div>
