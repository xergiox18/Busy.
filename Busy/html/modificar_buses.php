...
$id = $_GET["id"];
$sql = $conexion->query(" select * from buses where id_bus=$id ");
include "controlador/modificar_buses.php"
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" autocomplete="off" class="form-control"
                                                    name="placa" value="<?= $datos->placa ?>" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputName">Marca del Vehículo </label>
                                                <input type="text" autocomplete="off" class="form-control"
                                                    name="marca" value="<?= $datos->marca ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputName">Modelo del Vehículo</label>
                                                <input type="text" autocomplete="off" class="form-control" name="modelo"
                                                    value="<?= $datos->modelo ?>" required>
                                            </div>
                                        <?php } ?>
